...
//Declare properties for the buttons, plus two views we'll use to customize the appearance of the view:
...
//In the initializer, we'll create these objects and add them to the view hierarchy. We add targets for the buttons. We have a default image name (camera) for the camera button; the other two images will be passed in.
...
- (instancetype) initWithImageNames:(NSArray *)imageNames {
    ...
    if (self) {
        ...
        //Call createConstraints at the end of the initializer:
...
// We'll position the views with auto-layout:
...
//In layoutSubviews, round the top corners of the purple view with a mask layer.
- (void) layoutSubviews {
...
//Inform the delegate when the buttons are tapped:
