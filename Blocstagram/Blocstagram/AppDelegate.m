...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    // Assignment F35 - Data Persistence - try to fetch new content from the Instagram API
    DataSource *newInstance = [[DataSource alloc] init];
    [newInstance requestNewItemsWithCompletionHandler:(NewItemCompletionBlock)nil];
