...
//We set userInteractionEnabled to NO because this view doesn't handle any touch events. Let's update CameraViewController.m to use this new view instead of all of those line.
